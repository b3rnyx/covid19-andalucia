...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= config('app.url') ?>vendor/datatables/datatables.min.css">
...
<script type="text/javascript" src="<?= config('app.url') ?>vendor/datatables/datatables.min.js"></script>
